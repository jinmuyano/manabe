...
def fake_deploy_status_data():
    ...
    DeployStatus.objects.create(name="READY",description="准备发布",memo="准备发布")
    DeployStatus.objects.create(name="ING",description="发布中...",memo="发布中...")
    DeployStatus.objects.create(name="FINISH",description="发布完成",memo="发布完成")
    DeployStatus.objects.create(name="ERROR",description="发布异常",memo="发布异常")
